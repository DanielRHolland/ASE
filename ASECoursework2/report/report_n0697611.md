...
QuickCheck requires more careful consideration of the tests to be performed than HUnit. Simple tests are not difficult to write, but custom data types also require custom data generators. It took a while to figure out how to do this, but once I had a couple of working examples, adding more types became trivial. I expect that as a code base expands, the number of opportunities for reusing the generators will increase. 
