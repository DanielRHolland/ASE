...
![Comparison of Serial Algorithm with both Non-Serial Solutions](assets/vs3M.svg)

![Table of average results](assets/vs3M_t.svg)

The above table shows the Serial Algotithm to be consistently slower
